...
std::string EAEA::verifySignature(std::string message){
    ...
    std::string certPath = "/home/"+PATH_USER+"/in-secure_ring/ca/certs/"+messageParts.at(0)+".crt";
    fileManager.Write(messageParts.at(1),"/home/"+PATH_USER+"/in-secure_ring/ca/private/firma.sha256");
