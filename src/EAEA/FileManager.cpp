...
std::vector<std::string> FileManager::searchForMessages(std::vector<std::string>& directories){
...
void FileManager::saveMessage(std::string message){
	int result = -1;
...
std::vector<std::string> FileManager::SplitMessageFile(const std::string& fileContent){
...
bool FileManager::Write(const std::string& content, const std::string& filename) {
...
bool FileManager::WriteAppend(const std::string& content, const std::string& filename) {
...
std::string FileManager::convertToZeroPaddedString(int number)
{
...
void FileManager::searchFiles(const fs::path& directory, const std::string& filename, std::vector<FoundFile>& foundFiles)
{
